 ...
 * @version 20190108 add custom-template
 */
public class MidiParser {
  ...
  public MidiParser(File midiFile) throws MidiUnavailableException, IOException,
    ...
    System.out.println(midiFile.getCanonicalPath());
    ...
    System.out.println(seq.getTempoInMPQ());
  ...
  public void writeMidiTextFile() {
    ...
    try {
      ...
      writer = new FileWriter(this.filePathAndName);
      writer.append("tempo " + tempo + System.lineSeparator());
      int noteCount = 0;
      for (Note note : notes) {
        note.setTemplate(template);
        writer.append(note.toString() + System.lineSeparator());
        noteCount++;
      }
      writer.close();
